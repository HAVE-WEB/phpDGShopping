...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <div class="data-table" style="margin-top:20px;">
        ...
        <div class="table-striped">
            ...
            <a class="btn" href="<?php echo U('video_add',array('mdm'=>I('mdm')));?>">新 增</a>
            <?php if(C('MATERIAL')) { ?> 
                <a class="btn" href="<?php echo U('syc_video_to_wechat',array('mdm'=>$_GET['mdm']));?>">一键上传素材到微信素材库</a>
                <a class="btn" href="<?php echo U('syc_file_from_wechat',array('mdm'=>$_GET['mdm']));?>&type=2">一键下载微信素材库到本地</a>
             <?php } ?>
            </div>
                ...
                <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                	<div class="picture_item">
                        <div class="video_item">
                        	<p class="title ellipsis"><?php echo ($vo["title"]); ?></p>
                        ...
                        <div class="picture_action">
                            <a href="<?php echo U('video_edit',array('id'=>$vo[id],'mdm'=>$_GET['mdm']));?>">编辑</a>
