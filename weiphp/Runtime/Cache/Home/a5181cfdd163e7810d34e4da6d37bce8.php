        ...
        <form id="form" class="form-horizontal">
          <ul id="tab" class="tab-pane in">
          		<li class="form-item cf">
                		<div class="controls uploadrow2" rel="picurl">
                            <div class="upload-img-box" rel="img">
                                <div class="upload-pre-item2"><img width="100" height="100" src="<?php echo ($info["headimgurl"]); ?>"/></div>
                            </div>
                      </div>
                  </li>
            	 <li class="form-item cf">
                    <label class="item-label">昵称：<?php echo ($info["nickname"]); ?></label>
                  </li>  
                   <li class="form-item cf">
                    <label class="item-label">真实姓名：<?php echo ($info["truename"]); ?></label>
              
                  </li>
                   <li class="form-item cf">
                    <label class="item-label">性别：<?php echo ($info["sex_name"]); ?></label>
                  </li> 
                  <li class="form-item cf">
                    <label class="item-label">手机号：<?php echo ($info["mobile"]); ?></label>
              
                  </li>
                   <li class="form-item cf">
                    <label class="item-label">积分：<?php echo ($info["score"]); ?></label>
                  </li> 
                   <li class="form-item cf">
                    <label class="item-label">体验值：<?php echo ($info["experience"]); ?></label>
                  ...
                  <li class="form-item cf">
                    	<label class="item-label">所在分组：<?php echo ($info["groupstr"]); ?>
<!--                     	<?php if(is_array($info[groups])): $i = 0; $__LIST__ = $info[groups];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
<!--                         	<?php echo ($vo["title"]); ?>、 -->
