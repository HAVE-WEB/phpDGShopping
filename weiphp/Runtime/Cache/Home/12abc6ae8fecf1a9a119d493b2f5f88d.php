          ...
          <table cellspacing="0" class="message_list">
            ...
            <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td class="user">
                    ...
                    <?php else: ?>
                    	<img width="50" src="/weiphp/Public/Home/images/default.png"/><?php endif; ?>
                	<div class="u_info">
                ...
                <td valign="top"><?php echo (time_format($vo["CreateTime"])); ?></td>
                <td valign="top">
                <a href="<?php echo U('person',array('openid'=>$vo[openid],'mdm'=>I('mdm')));?>">会话详情</a>
                </td>
